...
public class ObjectInspector extends AbstractObjectInspector {

    @Override
    public boolean isIgnoredNode(Object node) {
        for (Field f : ValidatorHelper.getAllFieldsFromClass(node.getClass())) {
