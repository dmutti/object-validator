...
public class CollectionLengthProcessor extends AnnotationProcessor {

    private final int min;
    private final int max;

    public CollectionLengthProcessor(final Object target, final Field field, final Annotation annotation) {
        super(target, field, annotation, new InstanceOfTypeValidator(Collection.class));
        min = ((CollectionLength) getAnnotation()).min();
        max = ((CollectionLength) getAnnotation()).max();
    ...
    protected boolean isValidValue() {
        ...
        int tamanho = ((Collection<?>) value).size();
