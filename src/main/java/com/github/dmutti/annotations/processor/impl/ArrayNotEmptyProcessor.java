...
public class ArrayNotEmptyProcessor extends AnnotationProcessor {

    public ArrayNotEmptyProcessor(final Object target, final Field field, final Annotation annotation) {
