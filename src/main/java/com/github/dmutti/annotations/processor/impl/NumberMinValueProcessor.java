...
public class NumberMinValueProcessor extends AnnotationProcessor {

    private final double value;

    public NumberMinValueProcessor(final Object target, final Field field, final Annotation annotation) {
        ...
        value = ((NumberMinValue) annotation).value();
    }
    ...
    protected boolean isValidValue() {
        ...
        return ((Number) obj).doubleValue() >= value;
    }

    @Override
    protected String getErrorMessage() {
        return String.format(Locale.US, " deve ter o valor minimo [%.3f].", value);
    }
}
