...
public class StringNotEmptyProcessor extends AnnotationProcessor {


    public StringNotEmptyProcessor(final Object target, final Field field, final Annotation annotation) {
        super(target, field, annotation, new InstanceOfTypeValidator(String.class));
    }

    @Override
    protected boolean isValidValue() {
        return StringUtils.isNotEmpty(getObjectFieldFromTargetAsString());
    }
